...
// ##### 主副板设置
#define IS_MASTER_BORAD  1 // 1 为主板，0 为副板
...
*/
#define BAT_FILT_COEF           13100       // battery voltage filter coefficient in fixed-point. coef_fixedPoint = coef_floatingPoint * 2^16. In this case 655 = 0.01 * 2^16
#define BAT_CALIB_REAL_VOLTAGE  3610      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define SLAVE_BAT_CALIB_REAL_VOLTAGE  3610 
#define BAT_CALIB_ADC           952      // adc-value measured by mainboard (value nr 5 on UART debug output)
#define SLAVE_BAT_CALIB_ADC     952
...
#define TEMP_CAL_LOW_ADC        1197      // temperature 1: ADC value
#define TEMP_CAL_LOW_DEG_C      150       // temperature 1: measured temperature [�C * 10]. Here 35.8 �C
...
// 基于 MM32SPIN05 手册典型值修复 
#define V25_MV              1451  // 25°C 时的电压典型值 (mV)
#define AVG_SLOPE_UV        4801  // 平均斜率典型值 4.801 mV/°C = 4801 uV/°C
#define V_REF_MV            3280  // 您的实测 VDD/VDDA 电压 (mV)

// 报警阈值 (单位: °C * 10)
#define TEMP_WARNING        600   // 60.0 °C 报警
#define TEMP_POWEROFF       750   // 75.0 °C 关机保护
...
#define UART_BAUD             115200                  // UART baud rate (short wired cable)
//#define UART_BAUD             38400                  // UART baud rate (short wired cable)
// ########################### UART SETIINGS ############################
...
#define DEFAULT_RATE                320   // 30.0f [-] lower value == slower rate [0, 32767] = [0.0, 2047.9375]. Do NOT make rate negative (>32767)
...
#define MAX_SPEED_LIMIT  1000  // 设定限速 400转
